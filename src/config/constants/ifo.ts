...
const ifos: Ifo[] = [
  ...
  {
    id: 'fad',
    address: '0x5812ae5Ba92781203C762c96DC5701Df981AE777',
    isActive: true,
    name: 'FARM ADVENTURE',
    subTitle: 'Farmadventure is a multiplayer builder game, introducing blockchain to millions of players. Anyone can buy and own virtual islands, collect and build exciting items and meet new friends',
    description:
      'what is JILO?    Buy new tokens with a JILO Brand new model Javaswap initial Liquidity Offering, JILO Raised fund will be used to FAD added liquidity on javaswap as pair FAD/BNB-Lp & FAD/ANFT-Lp',
    launchDate: 'Aug 26',
    launchTime: '11: 59 AM GMT +7',
    saleAmount: '250,000,000 FAD',
    raiseAmount: '$100,000',
    cakeToBurn: '$5,000',
    projectSiteUrl: 'https://farmadventure.games/',
    currency: 'ANFT-BNB LP',
    currencyAddress: '0xa43CF0aCb7Caf9931221394E259bF68252F2c22b',
    tokenDecimals: 18,
    releaseBlockNumber: 10214144,
  },
]
