        ...
        <div>
          <Block>
            ...
            <Text mb={3}>
              {TranslateString(
                504,
                'You’ll pay for the new tokens using ANFT-BNB LP tokens, which means you need to stake equal amounts of ANFT and BNB in a liquidity pool to take part.',
              )}
            </Text>
            <Text mb={3}>
              <LiquidityLink href="https://dex.javaexchange.finance/#/add/ETH/0xce62f350cbd94397085cc42935eb108d2aa6beec">
                {TranslateString(506, 'Get ANFT-BNB LP >')}
              </LiquidityLink>
            </Text>
            <Text mb={3}>
              {TranslateString(508, 'The project gets the BNB, JAVASWAP burns the ANFT.')}
              <br />
