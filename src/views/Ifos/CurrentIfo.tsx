    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596, 'Buy ANFT and BNB tokens')}</li>
            <li>{TranslateString(598, 'Get ANFT-BNB LP tokens by adding ANFT and BNB liquidity')}</li>
          </List>
          <Flex mb="16px">
            <LinkExternal href="https://dex.javaexchange.finance/#/swap/" mr="16px">
              {TranslateString(999, 'Buy ANFT')}
            </LinkExternal>
            <LinkExternal href="https://dex.javaexchange.finance/#/add/ETH/0x4ad871d02415717f55adb23def23faec98e7bba8">
              {TranslateString(999, 'Get LP tokens')}
            </LinkExternal>
          </Flex>
          <Heading mb="16px">{TranslateString(600, 'During Sale')}:</Heading>
          <List>
            <li>{TranslateString(999, 'While the sale is live, commit your ANFT-LP tokens to buy the JILO tokens')}</li>
          </List>
          <Heading mb="16px">{TranslateString(604, 'After Sale')}:</Heading>
          <List>
            <li>{TranslateString(999, 'Claim the tokens you purchased.')}</li>
